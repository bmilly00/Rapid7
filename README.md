...
|---|---|---|
| June 2026 full export (`Vulnerabilitiesv1.csv`) — 2,748 findings across Chrome, Edge, Adobe, Windows, Office, ASP.NET Core, 7-Zip, TLS/SSL config, SMB signing, CVE-2013-3900 and more (**AutoCAD, VNC, auto-logon and lockout policy excluded by policy; never reboots**) | [`All-In-One-Remediation/`](All-In-One-Remediation/) | Single all-in-one PowerShell remediation script + Endpoint Central Custom Script deployment guide |
